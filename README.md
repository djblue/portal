...
For an in-depth explanation of the UI, you can jump to the [UI](https://cljdoc.org/d/djblue/portal/0.27.0/doc/ui-concepts) docs.
...
```bash
clj -Sdeps '{:deps {djblue/portal {:mvn/version "0.27.0"}}}'
```
...
```bash
bb -cp `clj -Spath -Sdeps '{:deps {djblue/portal {:mvn/version "0.27.0"}}}'`
```
...
For more documentation, take a look through the [docs](https://cljdoc.org/d/djblue/portal/0.27.0/doc/ui-concepts).
