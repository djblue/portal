...
```bash
clj -Sdeps '{:deps {djblue/portal {:mvn/version "0.49.1"}}}'
```
...
```bash
bb -Sdeps '{:deps {djblue/portal {:mvn/version "0.49.1"}}}'
```
...
```clojure
{:portal {:dependencies [[djblue/portal "0.49.1"]]}}
```
...
[docs]: https://cljdoc.org/d/djblue/portal/0.49.1/doc/ui-concepts
[ui-concepts]: https://cljdoc.org/d/djblue/portal/0.49.1/doc/ui-concepts
