...
```bash
bb -Sdeps '{:deps {djblue/portal {:mvn/version "0.58.4"}}}'
```
...
```clojure
{:portal {:dependencies [[djblue/portal "0.58.4"]]}}
```
...
[docs]: https://cljdoc.org/d/djblue/portal/0.58.4/doc/ui-concepts
[ui-concepts]: https://cljdoc.org/d/djblue/portal/0.58.4/doc/ui-concepts
