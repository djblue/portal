...
```bash
clj -Sdeps '{:deps {djblue/portal {:mvn/version "0.55.1"}}}'
```
...
```bash
bb -Sdeps '{:deps {djblue/portal {:mvn/version "0.55.1"}}}'
```
...
[ui-concepts]: https://cljdoc.org/d/djblue/portal/0.55.1/doc/ui-concepts
