...
For an in-depth explanation of the UI, you can jump to the [UI](https://cljdoc.org/d/djblue/portal/0.29.1/doc/ui-concepts) docs.
...
```bash
clj -Sdeps '{:deps {djblue/portal {:mvn/version "0.29.1"}}}'
```
...
```bash
bb -cp `clj -Spath -Sdeps '{:deps {djblue/portal {:mvn/version "0.29.1"}}}'`
```
...
For more documentation, take a look through the [docs](https://cljdoc.org/d/djblue/portal/0.29.1/doc/ui-concepts).
