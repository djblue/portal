...
```bash
clj -Sdeps '{:deps {djblue/portal {:mvn/version "0.37.1"}}}'
```
...
```bash
bb -cp `clj -Spath -Sdeps '{:deps {djblue/portal {:mvn/version "0.37.1"}}}'`
```
...
```clojure
{:profiles {:portal {:dependencies [[djblue/portal "0.37.1"]]}}}
```

Or as a global profile, add to `~/.lein/profiles.clj`:

```clojure
{:portal {:dependencies [[djblue/portal "0.37.1"]]}}
```
...
[docs]: https://cljdoc.org/d/djblue/portal/0.37.1/doc/ui-concepts
[ui-concepts]: https://cljdoc.org/d/djblue/portal/0.37.1/doc/ui-concepts
