...
```bash
clj -Sdeps '{:deps {djblue/portal {:mvn/version "0.36.0"}}}'
```
...
```clojure
{:profiles {:dev {:dependencies [[djblue/portal "0.36.0"]]}}}
```

or

```clojure
{:profiles {:portal {:dependencies [[djblue/portal "0.36.0"]]}}}
```

Or as a global profile, add to `~/.lein/profiles.clj`:

```clojure
{:portal {:dependencies [[djblue/portal "0.36.0"]]}}
```
...
[docs]: https://cljdoc.org/d/djblue/portal/0.36.0/doc/ui-concepts
[ui-concepts]: https://cljdoc.org/d/djblue/portal/0.36.0/doc/ui-concepts
