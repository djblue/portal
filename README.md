...
```bash
clj -Sdeps '{:deps {djblue/portal {:mvn/version "0.56.0"}}}'
```
...
```clojure
{:profiles {:dev {:dependencies [[djblue/portal "0.56.0"]]}}}
```

or as a global profile, add to `~/.lein/profiles.clj`:

```clojure
{:portal {:dependencies [[djblue/portal "0.56.0"]]}}
```
...
[docs]: https://cljdoc.org/d/djblue/portal/0.56.0/doc/ui-concepts
[ui-concepts]: https://cljdoc.org/d/djblue/portal/0.56.0/doc/ui-concepts
