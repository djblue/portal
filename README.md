...
```bash
clj -Sdeps '{:deps {djblue/portal {:mvn/version "0.34.2"}}}'
```
...
```bash
bb -cp `clj -Spath -Sdeps '{:deps {djblue/portal {:mvn/version "0.34.2"}}}'`
```
...
```clojure
{:profiles {:dev {:dependencies [[djblue/portal "0.34.2"]]}}}
```

or

```clojure
{:profiles {:portal {:dependencies [[djblue/portal "0.34.2"]]}}}
```

Or as a global profile, add to `~/.lein/profiles.clj`:

```clojure
{:portal {:dependencies [[djblue/portal "0.34.2"]]}}
```
...
[docs]: https://cljdoc.org/d/djblue/portal/0.34.2/doc/ui-concepts
[ui-concepts]: https://cljdoc.org/d/djblue/portal/0.34.2/doc/ui-concepts
