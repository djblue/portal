...
```bash
clj -Sdeps '{:deps {djblue/portal {:mvn/version "0.42.1"}}}'
```
...
```bash
bb -Sdeps '{:deps {djblue/portal {:mvn/version "0.42.1"}}}'
```
...
```clojure
{:profiles {:dev {:dependencies [[djblue/portal "0.42.1"]]}}}
```

or

```clojure
{:profiles {:portal {:dependencies [[djblue/portal "0.42.1"]]}}}
```
...
[docs]: https://cljdoc.org/d/djblue/portal/0.42.1/doc/ui-concepts
[ui-concepts]: https://cljdoc.org/d/djblue/portal/0.42.1/doc/ui-concepts
