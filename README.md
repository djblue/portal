...
```bash
clj -Sdeps '{:deps {djblue/portal {:mvn/version "0.54.2"}}}'
```
...
```bash
bb -Sdeps '{:deps {djblue/portal {:mvn/version "0.54.2"}}}'
```

or for a lein `project.clj`, add:

```clojure
{:profiles {:dev {:dependencies [[djblue/portal "0.54.2"]]}}}
```

or as a global profile, add to `~/.lein/profiles.clj`:

```clojure
{:portal {:dependencies [[djblue/portal "0.54.2"]]}}
```
...
[docs]: https://cljdoc.org/d/djblue/portal/0.54.2/doc/ui-concepts
[ui-concepts]: https://cljdoc.org/d/djblue/portal/0.54.2/doc/ui-concepts
