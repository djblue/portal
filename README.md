...
```bash
clj -Sdeps '{:deps {djblue/portal {:mvn/version "0.38.2"}}}'
```
...
```clojure
{:profiles {:dev {:dependencies [[djblue/portal "0.38.2"]]}}}
```

or

```clojure
{:profiles {:portal {:dependencies [[djblue/portal "0.38.2"]]}}}
```

Or as a global profile, add to `~/.lein/profiles.clj`:

```clojure
{:portal {:dependencies [[djblue/portal "0.38.2"]]}}
```
...
[ui-concepts]: https://cljdoc.org/d/djblue/portal/0.38.2/doc/ui-concepts
