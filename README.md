...
```bash
clj -Sdeps '{:deps {djblue/portal {:mvn/version "0.43.0"}}}'
```
...
```bash
bb -Sdeps '{:deps {djblue/portal {:mvn/version "0.43.0"}}}'
```
...
```clojure
{:profiles {:dev {:dependencies [[djblue/portal "0.43.0"]]}}}
```

or

```clojure
{:profiles {:portal {:dependencies [[djblue/portal "0.43.0"]]}}}
```

Or as a global profile, add to `~/.lein/profiles.clj`:

```clojure
{:portal {:dependencies [[djblue/portal "0.43.0"]]}}
```
...
[docs]: https://cljdoc.org/d/djblue/portal/0.43.0/doc/ui-concepts
[ui-concepts]: https://cljdoc.org/d/djblue/portal/0.43.0/doc/ui-concepts
